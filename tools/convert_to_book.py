...
class ConvertToBook:
    ...
    """
    def __init__(self, script_file, book_target_path, event_storage, book_title='Retention Metrics', matplotlib=True):
    ...
    def write_book(self):
        ...
        # set proper directory for storage
        script_file_contents = script_file_contents.replace('___EVENT_STORAGE___', self.event_storage)
