...
dev_book = ConvertToBook(
    script_file=os.path.join(books_dir, '..', 'metrics', 'retention_account_created.py'),
    book_title='User Retention using account.created events DEVELOPMENT',
...
prod_book = ConvertToBook(
    script_file=os.path.join(books_dir, '..', 'metrics', 'retention_account_created.py'),
    book_title='User Retention using account.created events',
